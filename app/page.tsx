  ...
  return (
    <main className="site-shell" onMouseMove={(event) => setSpotlight({ x: (event.clientX / window.innerWidth) * 100, y: (event.clientY / window.innerHeight) * 100 })}>
      ...
      <section id="top" className="hero container">
        ...
        <div className="hero-visual reveal"><div className="frame-corner corner-tl" /><div className="frame-corner corner-br" /><div className="portrait-wrap"><img src="/cyborg-portrait.png" alt="Cybernetic portrait representing Akash's creative technology work" /></div><div className="visual-label label-top">SYSTEM / CREATIVE_TECH</div><div className="visual-label label-bottom">SIGNAL: HUMAN + MACHINE</div><div className="scanline" /></div>
      </section>
      ...
      <section id="contact" className="section container reveal"><div className="section-head"><span className="section-number">04</span><h2>Open channel</h2><span className="rule" /></div><div className="contact-layout"><div><p className="contact-kicker">Have a problem worth solving?</p><h2 className="contact-title">Let&apos;s make<br /><span>something real.</span></h2><a className="button button-primary" href="mailto:ramrajjnk75@gmail.com">Start a conversation <span>↗</span></a></div><div className="contact-grid"><a href="https://github.com/A18990" target="_blank" rel="noreferrer"><span>GH</span><strong>GitHub</strong><small>@A18990</small></a><a href="https://instagram.com/Rohanpathak47" target="_blank" rel="noreferrer"><span>IG</span><strong>Instagram</strong><small>@Rohanpathak47</small></a><a href="mailto:ramrajjnk75@gmail.com"><span>→</span><strong>Email</strong><small>ramrajjnk75@gmail.com</small></a><a href="https://tiktok.com/@Rohanpathak47" target="_blank" rel="noreferrer"><span>TK</span><strong>TikTok</strong><small>@Rohanpathak47</small></a></div></div></section>
